            ...
            <div class="form-content">
                ...
                <form action="" method="post"> <!-- Change action to your PHP script -->
                    <div class="field input-field">
                        <input type="text" placeholder="First Name" class="input form-control" name="first_name" required>
                    </div>

                    <div class="field input-field">
                        <input type="text" placeholder="Last Name" class="input form-control" name="last_name" required>
                    </div>

                    <div class="field input-field">
                    <input type="text" placeholder="Username" class="input form-control" name="username" required>

                    </div>

                    <div class="field input-field">
                        <input type="password" placeholder="Create password" class="password form-control" name="CrPass" required>
                    </div>

                    <div class="field input-field">
                        <input type="password" placeholder="Confirm password" class="password form-control" name="CnPass" required>
                        <i class='bx bx-hide eye-icon'></i>
                    </div>

                    <div class="field input-field">
                        <input type="tel" placeholder="Phone Number" class="input form-control" name="phone" required>
                    </div>
